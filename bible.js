...
{
	names:n('Nehemiah Ne Neh Neh Ne')
	,verses:[11,20,32,23,19,19,73,18,38,39,36,47,31]
},
{
	names:n('Esther Es Est Esth')
...
{
	names:n('Lamentations La Lam Lament')
	,verses:[22,22,66,22,22]
},
{
	names:n('Ezekiel Ek Ezek Eze')
...
{
	names:n('Daniel Da Dan Dl Dnl')
	,verses:[21,49,30,37,31,28,28,27,27,21,45,13]
},
{
	names:n('Hosea Ho Hos')
	,verses:[11,23,5,19,15,11,16,14,17,15,12,14,16,9]
},
{
	names:n('Joel Jl Joel Joe')
	,verses:[20,32,21]
},
{
	names:n('Amos Am Amos Amo')
	,verses:[15,16,15,13,27,14,17,14,15]
},
{
	names:n('Obadiah Ob Oba Obd Odbh')
	,verses:[21]
},
{
	names:n('Jonah Jh Jon Jnh')
	,verses:[17,10,10,11]
},
{
	names:n('Micah Mi Mic')
	,verses:[16,13,12,13,15,16,20]
},
{
	names:n('Nahum Na Nah Nah Na')
	,verses:[15,13,19]
},
{
	names:n('Habakkuk Hb Hab Hk Habk')
	,verses:[17,20,19]
},
{
	names:n('Zephaniah Zp Zep Zeph Ze')
	,verses:[18,15,20]
},
{
	names:n('Haggia Ha Hag Hagg')
	,verses:[15,23]
},
{
	names:n('Zechariah Zc Zech Zec')
	,verses:[21,13,10,14,11,15,14,23,17,12,17,14,9,21]
},
{
	names:n('Malachi Ml Mal Mlc')
	,verses:[14,17,18,6]
},
{
	names:n('Matthew Mt Matt Mat')
	,verses:[25,23,17,25,48,34,29,34,38,42,30,50,58,36,39,28,27,35,30,34,46,46,39,51,46,75,66,20]
},
{
	names:n('Mark Mk Mar Mrk')
	,verses:[45,28,35,41,43,56,37,38,50,52,33,44,37,72,47,20]
},
{
	names:n('Luke Lk Luk Lu')
	,verses:[80,52,38,44,39,49,50,56,62,42,54,59,35,35,32,31,37,43,48,47,38,71,56,53]
},
{
	names:n('John Jn Joh Jo')
...
{
	names:n('Romans Ro Rom Rmn Rmns')
	,verses:[32,29,31,25,21,23,25,39,33,21,36,21,14,23,33,27]
},
{
	names:ordinals(1,'Corinthians Cor Co')
	,verses:[31,16,23,21,13,20,40,13,27,33,34,31,13,40,58,24]
},
{
	names:ordinals(2,'Corinthians Cor Co')
	,verses:[24,17,18,18,21,18,16,24,15,18,33,21,14]
},
{
	names:n('Galatians Ga Gal Gltns')
	,verses:[24,21,29,31,26,18]
},
{
	names:n('Ephesians Ep Eph Ephn')
	,verses:[23,22,21,32,33,24]
},
{
	names:n('Philippians Pp Phi Phil Phi')
	,verses:[30,30,21,23]
},
{
	names:n('Colossians Co Col Colo Cln Clns')
	,verses:[29,23,25,18]
},
{
	names:ordinals(1,'Thessalonians Thess Thes Th')
	,verses:[10,20,13,18,28]
},
{
	names:ordinals(2,'Thessalonians Thess Thes Th')
	,verses:[12,17,18]
},
{
	names:ordinals(1,'Timothy Tim Ti')
	,verses:[20,15,16,16,25,21]
},
{
	names:ordinals(2,'Timothy Tim Ti')
	,verses:[18,26,17,22]
},
{
	names:n('Titus Ti Tit Tt Ts')
	,verses:[16,15,15]
},
{
	names:n('Philemon Pm Phile Phile Philm Pm')
	,verses:[25]
},
{
	names:n('Hebrews He Heb Hw')
	,verses:[14,18,19,16,14,20,28,13,28,39,40,29,25]
},
{
	names:n('James Jm Jam Jas Ja')
	,verses:[27,26,18,17,20]
},
{
	names:ordinals(1,'Peter Pet Pe P')
	,verses:[25,25,22,19,14]
},
{
	names:ordinals(2,'Peter Pet Pe P')
	,verses:[21,22,18]
},
{
...
{
	names:n('Jude Jude Jude')
	,verses:[25]
},
{
	names:n('Revelation Re Rev Rvltn')
